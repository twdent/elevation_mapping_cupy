...
class ShiftGridMapNode:
    def __init__(self):
        self.gridmap_sub_topic = rospy.get_param("~gridmap_sub_topic", "/elevation_mapping/traversable_segmentation")
        ...
        self.offset_factor_x = rospy.get_param("~offset_factor_x", 1)
        self.offset_factor_y = rospy.get_param("~offset_factor_y", 1)
